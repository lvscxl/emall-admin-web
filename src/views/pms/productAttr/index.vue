    ...
    <div class="app-container">
        ...
        <div class="table-container">
            ...
            >
              ...
              <el-table-column label="类型名称" width="100%" align="center">
        ...
        width="30%">
        <el-form ref="productAttrCatForm" :model="productAttrCate" :rules="rules" >
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="handleConfirm('productAttrCateForm')"> 确定</el-button>
            </span>
...
export default {
    ...
    getAttrList(index, row) {
       // this.$router.push({path: '/pms/productAttrList',query:{cid:row.id,cname:row.name,type:0}})
        ...
        //this.$router.push({path: '/pms/productAttr',query:{cid:row.id,cname:row.name,type:0}})
