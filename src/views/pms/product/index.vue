            ...
            <div>
                <el-form :model="listQuery">
                    ...
                    <el-form-item label="商品品牌：">
                        <el-select 
                          v-model="listQuery.brandId" placeholder="请选择品牌" clearable>
                            <el-option 
                    ...
                    <el-form-item  label="审核状态：">
                        <el-select v-model="listQuery.verfyStatus" placeholder="全部">
                            <el-option 
            ...
            >
               ...
               <el-table-column label="商品名称">
                ...
                <el-table-column label="审核状态">
                    <template slot-scope="scope">
                        <p> {{scope.row.verfyStatus | verifyStatusFilter}}</p>
                        <p>
...
<script>
  ...
  import {fetchSkuStockList, update} from '@/api/skuStock'
     ...
     data() {
       ...
       watch: {
           selectProductCateValue: function (newValue) {
               if(newValue != null && newValue.lengthv==v2) {
               ...
               fetchListWithChildren().then( response => {
                   ...
                   for( let i = 0; i < list.length; i++) {
                       ...
                       if( list[i].children != null && list[i].children.length > 0) {
                           for( let j = 0; j < list[j].children.children; j++) {
